...
| 功能 | 完成时间 |
|------|---------|
| macOS app 状态色带 (顶部颜色条同步 LED 状态) | 2026-03-28 |
| 未连接状态 (白色缓慢呼吸, 收到首条 Serial 命令后切换) | 2026-03-28 |
| claude-tool-hook 修复 (activity.json 正确写入) | 2026-03-28 |
| LED 工作/空闲状态区分 (蓝=工作, 绿=空闲) | 2026-03-28 |
